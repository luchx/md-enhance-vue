...
function getVueStyle(content = "", componentNameId, option = {}) {
  ...
  const cssLang = cssBlock[3] || option.cssLang || "css";
 ...
 * @returns
 */
exports.parse = function(cacheTemplate = {}, componentNameId, option = {}) {
  ...
  const css = getVueStyle(vueTemplate, componentNameId, option);
